...
def print_help():
   ...
   print "-M:\t Match. Matches the input data with a known pattern, using the classifier."
   print "-p:\t Print. Print numpy array containing spectrum to terminal."
   print "-T:\t Train. Trains the classifier using .Spectrum files in ./training_data. Please see the example use of the call."
   ...
   print "-w:\t Write. Write spectrum to file, each array element on its own line. Also creates a .Spectrum file"
   ...
   print "   python Analysis.py -T none"
   print "                         ^ writing 'none' here is required"
